...
[English](/user_development_guide/README_en.md) · [文档索引](/index.md)
...
公网 Registry 按名称返回当前 Skill 条目，不提供历史版本子路径。
`paos skill install <name> --version <version>` 中的版本是客户端约束：Bundle 下载后先校验 manifest version，
