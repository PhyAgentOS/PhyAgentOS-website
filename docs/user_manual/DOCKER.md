...
> 版本：1.0.0 · [English](/user_manual/DOCKER_en.md)

PhyAgentOS 提供基于 Docker 的快速部署方案，无需手动配置 Python / Node.js 环境。配合 [`scripts/install.sh`](https://github.com/PhyAgentOS/PhyAgentOS-core/blob/main/scripts/install.sh) 一键脚本，可在一分钟内完成构建、初始化与运行。
...
仓库已提供 [`docker-compose.yml`](https://github.com/PhyAgentOS/PhyAgentOS-core/blob/main/docker-compose.yml)，适合需要常驻服务的场景。
...
- [`Dockerfile`](https://github.com/PhyAgentOS/PhyAgentOS-core/blob/main/Dockerfile) — 镜像构建定义
- [`docker-compose.yml`](https://github.com/PhyAgentOS/PhyAgentOS-core/blob/main/docker-compose.yml) — Compose 编排
- [`.dockerignore`](https://github.com/PhyAgentOS/PhyAgentOS-core/blob/main/.dockerignore) — 构建忽略规则
- [`scripts/install.sh`](https://github.com/PhyAgentOS/PhyAgentOS-core/blob/main/scripts/install.sh) — 一键安装脚本
