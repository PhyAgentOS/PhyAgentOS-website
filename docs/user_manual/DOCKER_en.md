...
> Version: 1.0.0 · [中文](/user_manual/DOCKER.md)

PhyAgentOS ships with a Docker-based quick deployment that requires no manual Python / Node.js setup. Together with the [`scripts/install.sh`](https://github.com/PhyAgentOS/PhyAgentOS-core/blob/main/scripts/install.sh) one-click script, you can build, initialize, and run in under a minute.
...
The repo ships a [`docker-compose.yml`](https://github.com/PhyAgentOS/PhyAgentOS-core/blob/main/docker-compose.yml) for scenarios that need a persistent service.
...
- [`Dockerfile`](https://github.com/PhyAgentOS/PhyAgentOS-core/blob/main/Dockerfile) — image build definition
- [`docker-compose.yml`](https://github.com/PhyAgentOS/PhyAgentOS-core/blob/main/docker-compose.yml) — Compose orchestration
- [`.dockerignore`](https://github.com/PhyAgentOS/PhyAgentOS-core/blob/main/.dockerignore) — build-ignore rules
- [`scripts/install.sh`](https://github.com/PhyAgentOS/PhyAgentOS-core/blob/main/scripts/install.sh) — one-click install script
