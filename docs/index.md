...
| 开发、打包并发布 Forge Skill | [集成开发指南](/user_development_guide/README.md#_5-打包、发布与本地闭环) → [Forge 接入契约](/forge/README_zh.md) |
...
| Develop, package, and publish a Forge Skill | [Integration Guide](/user_development_guide/README_en.md#_5-package-publish-and-close-the-local-loop) → [Forge Integration Contract](/forge/README.md) |
