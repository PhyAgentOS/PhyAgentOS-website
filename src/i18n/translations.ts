  ...
  zh: {
    ...
    hardware: {
      ...
      items: [
        ...
        {'type': '双足人形', 'description': '宇树 R1-A5 双足人形机器人平台。'},
        {'type': '轮式人形', 'description': '兼顾移动效率与上肢操作的轮式人形机器人。'},
        {'type': '轮式人形', 'description': '面向感知、导航与操作流程的轮式人形平台。'},
        {'type': '轮式人形', 'description': '适合长程具身任务的轮式人形机器人。'},
