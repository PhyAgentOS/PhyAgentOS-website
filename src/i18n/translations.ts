...
export const translations: Record<Lang, TranslationShape> = {
  en: {
    ...
    coreConcepts: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Tool execution outcomes are recorded independently from task success. Before/after observations form an EvidenceBundle, and the isolated Verification Service evaluates each criterion without rewriting what physically happened.',
    ...
    architecture: {
      ...
      description: 'Track A handles reasoning, verification, and experience; Track B exposes robot, policy, and sensor capabilities through Forge Skills and executes them through the unified Forge Tool API.',
      trackA: 'Track A',
      ...
      nodes: [
        ...
        { label: 'Robot / Policy / Sensor', sublabel: 'Tool Capabilities', description: 'Packages robot actions, policy inference, and sensor observations as discoverable ToolSpecs required by an activated Forge Skill.' },
        { label: 'Forge Gateway', sublabel: 'Routing & Admission', description: 'Provides the unified /tools and /invocations entry point, routes calls to live ToolEndpoints, and reports invocation state and observations without deciding semantic task success.' },
        { label: 'ToolEndpoint + Dora', sublabel: 'Physical Execution', description: 'Runs the selected robot, policy, simulator, or sensor operation; endpoint concurrency and device-specific controls remain on the Forge side.' },
      ],
    ...
    scenarios: {
      ...
      description: 'The Agent activates a Forge Skill for the task, invokes live capabilities through the unified Tool API, and closes the loop with evidence and verification across real robots, simulation, and games.',
      items: [
        {
          title: 'Game',
          subtitle: 'Local · Minecraft / Stardew Valley / Don\'t Starve',
          description: 'Forge Skills combine game-state observations and action tools for long-horizon planning, interaction, and recovery in Minecraft, Stardew Valley, and Don\'t Starve.',
          features: ['Game-state observation Tools', 'Long-horizon Skill workflows', 'Planning and recovery', 'Auditable task results'],
        },
        {
          title: 'Simulation',
          subtitle: 'Example · LIBERO / RoboCasa365 / CALVIN',
          description: 'Forge Skills orchestrate simulator and policy Tools for reproducible LIBERO, CALVIN, and RoboCasa365 evaluation, with execution records, evidence, and semantic verdicts attached to each AgentTask.',
          features: ['Simulator and policy Tools', 'Version-bound Skill workflows', 'Evidence-backed evaluation', 'Verifier-guided recovery'],
        },
        {
          title: 'Real Robot',
          subtitle: 'Example · PIPER / Go2 / XLeRobot',
          description: 'Activated Forge Skills compose robot, policy, and sensor Tools to execute manipulation, navigation, and coordination tasks on physical hardware, then verify the outcome from captured evidence.',
          features: ['Robot / policy / sensor Tools', 'Natural-language task execution', 'Before-and-after evidence', 'Semantic verification and recovery'],
        },
      ],
      note: 'All three environments share the same loop: activate a version-bound Forge Skill, discover live ToolSpecs, execute through Forge, collect evidence, verify criteria, and recover through a new PlanRevision when needed.',
    },
    hardware: {
      label: 'Hardware',
      title: 'Supported',
      highlight: 'Targets',
      description: 'Through Forge Skills and live Tool capabilities, PhyAgentOS covers simulation and real-robot targets from desktop arms to quadrupeds, humanoids, and mobile manipulators.',
      devices: 'Devices',
      ...
      items: [
        { type: 'Desktop Arm', description: 'Real-robot target with a ReKep and SAM3 grasping workflow exposed through Forge Skills.' },
        ...
        { type: 'Industrial Arm', description: 'Industrial-grade precision arm target available through MuJoCo and Forge Tools.' },
        ...
        { type: 'Industrial Arm', description: 'Kinova Gen3 collaborative arm target available through MuJoCo.' },
        { type: 'Desktop Arm', description: 'Dobot Nova 2 collaborative desktop arm target available through MuJoCo.' },
        { type: 'Desktop Arm', description: 'RealMan ECO62-B collaborative arm target, officially maintained with MuJoCo support.' },
        { type: 'Desktop Arm', description: 'RealMan ECO63-B collaborative arm target, officially maintained with MuJoCo support.' },
        { type: 'Desktop Arm', description: 'RealMan ECO65-B collaborative arm target, officially maintained with MuJoCo support.' },
        { type: 'Desktop Arm', description: 'RealMan GEN72-B seven-axis collaborative arm target, officially maintained with MuJoCo support.' },
        { type: 'Desktop Arm', description: 'RealMan RM75-B seven-axis collaborative arm target, officially maintained with MuJoCo support.' },
        { type: 'Desktop Arm', description: 'RealMan RML63-B lightweight collaborative arm target, officially maintained with MuJoCo support.' },
        { type: 'Desktop Arm', description: 'RealMan RXR-B dual-arm target, officially maintained with MuJoCo support.' },
        ...
        { type: 'Mobile Manipulator', description: 'Bimanual mobile manipulation target available through MuJoCo and Forge Skills.' },
    ...
    testimonials: {
      ...
      items: [
        { quote: "Version-bound Forge Skills make sim-to-real workflows reproducible across LIBERO and our Franka arm.", author: 'Research Team', role: 'HCP Lab, Sun Yat-sen University / X-Era Lab' },
        { quote: "The unified Forge Tool API gives robot, policy, and sensor capabilities one clear integration boundary.", author: 'Contributors', role: 'Open Source Community' },
    ...
    docsCTA: {
      ...
      items: [
        { title: 'Architecture', subtitle: 'Technical Documentation', description: 'Understand AgentTask, Forge Skill binding, the unified Tool API, evidence, verification, recovery, and experience evolution.' },
        ...
        { title: 'Developer Guide', subtitle: 'Secondary Development', description: 'Integrate ToolEndpoints and Dora nodes, package Manifest v2 Forge Skills, connect policies and sensors, and validate the local execution loop.' },
      ],
    },
    langToggle: {
      switchTo: '切换语言',
  ...
  zh: {
    ...
    coreConcepts: {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Tool 执行结果与任务成功判定分别记录；动作前后观测组成 EvidenceBundle，隔离的 Verification Service 逐项判断 criteria，但不会改写物理世界中已发生的事实。',
    ...
    architecture: {
      ...
      title: 'Agent–Forge',
      highlight: '双轨架构',
      description: 'Track A 承载推理、验证与经验沉淀；Track B 通过 Forge Skill 暴露机器人、策略与传感器能力，并经统一 Forge Tool API 执行。',
      trackA: 'Track A',
      ...
      nodes: [
        ...
        { label: 'Robot / Policy / Sensor', sublabel: '工具能力', description: '把机器人动作、策略推理与传感器观测封装为可发现的 ToolSpec，供已激活的 Forge Skill 组合调用。' },
        { label: 'Forge Gateway', sublabel: '路由与接纳', description: '提供统一的 /tools 与 /invocations 入口，将调用路由到在线 ToolEndpoint，并返回调用状态与观测；任务是否成功由验证层判定。' },
        { label: 'ToolEndpoint + Dora', sublabel: '物理执行', description: '实际运行机器人、策略、仿真器或传感器操作；并发与设备特定控制保留在 Forge 执行侧。' },
      ],
      flowLabel: '可审计任务闭环',
    ...
    scenarios: {
      ...
      title: '一套 Forge，',
      highlight: '三类任务',
      description: 'Agent 根据任务激活 Forge Skill，经统一 Tool API 调用在线能力，并在真机、仿真与游戏环境中完成证据采集和结果验证。',
      items: [
        {
          title: '游戏',
          subtitle: '本地 · Minecraft / 星露谷 / 饥荒',
          description: 'Forge Skill 组合游戏状态观测与动作 Tool，在 Minecraft、星露谷与饥荒中完成长程规划、环境交互与失败恢复。',
          features: ['游戏状态观测 Tool', '长程 Skill 工作流', '规划与恢复', '可审计任务结果'],
        },
        {
          title: '仿真',
          subtitle: '示例 · LIBERO / RoboCasa365 / CALVIN',
          description: 'Forge Skill 编排仿真器与策略 Tool，在 LIBERO、CALVIN 与 RoboCasa365 中执行可复现测评，并将执行记录、证据与语义判定归入 AgentTask。',
          features: ['仿真器与策略 Tool', '版本绑定 Skill 工作流', '证据驱动测评', 'Verifier 引导恢复'],
        },
        {
          title: '真机',
          subtitle: '示例 · PIPER / Go2 / XLeRobot',
          description: '已激活的 Forge Skill 组合机器人、策略与传感器 Tool，在物理硬件上执行操作、导航与协同任务，并依据采集证据验证结果。',
          features: ['机器人 / 策略 / 传感器 Tool', '自然语言任务执行', '动作前后证据采集', '语义验证与恢复'],
        },
      ],
      note: '三类环境共享同一任务闭环：激活版本绑定的 Forge Skill，发现在线 ToolSpec，经 Forge 执行、采集证据并验证 criteria；需要时追加新的 PlanRevision 恢复。',
    },
    hardware: {
      label: '硬件设备',
      title: '支持的',
      highlight: '构型',
      description: '通过 Forge Skill 与在线 Tool 能力，PhyAgentOS 覆盖仿真与真机构型，从桌面机械臂到四足、人形与移动操作机器人。',
      devices: '个设备',
      statusReal: '真机验证',
      ...
      items: [
        ...
        {'type': '桌面机械臂', 'description': 'Dobot Nova 2 具身仿真桌面协作机械臂，支持 MuJoCo。'},
        {'type': '桌面机械臂', 'description': '睿尔曼 ECO62-B 协作机械臂，由官方维护并支持 MuJoCo。'},
        {'type': '桌面机械臂', 'description': '睿尔曼 ECO63-B 协作机械臂，由官方维护并支持 MuJoCo。'},
        {'type': '桌面机械臂', 'description': '睿尔曼 ECO65-B 协作机械臂，由官方维护并支持 MuJoCo。'},
        {'type': '桌面机械臂', 'description': '睿尔曼 GEN72-B 七轴协作机械臂，由官方维护并支持 MuJoCo。'},
        {'type': '桌面机械臂', 'description': '睿尔曼 RM75-B 七轴协作机械臂，由官方维护并支持 MuJoCo。'},
        {'type': '桌面机械臂', 'description': '睿尔曼 RML63-B 轻量协作机械臂，由官方维护并支持 MuJoCo。'},
        {'type': '桌面机械臂', 'description': '睿尔曼 RXR-B 双臂机器人，由官方维护并支持 MuJoCo。'},
    ...
    testimonials: {
      ...
      items: [
        { quote: '版本绑定的 Forge Skill 让 LIBERO 与 Franka 机械臂之间的 sim-to-real 工作流可复现。', author: '研究团队', role: '中山大学 HCP 实验室 / X-Era Lab' },
        { quote: '统一 Forge Tool API 为机器人、策略与传感器能力提供了清晰一致的集成边界。', author: '贡献者', role: '开源社区' },
    ...
    docsCTA: {
      ...
      joinDiscussion: '参与讨论',
      items: [
        { title: '系统架构', subtitle: '技术文档', description: '深入了解 AgentTask、Forge Skill 绑定、统一 Tool API、证据、验证、恢复与经验进化。' },
        { title: '用户手册', subtitle: '安装与操作', description: '使用 `paos` 安装、初始化工作区、运行 `paos agent`、连接 Runtime 服务，并为真机部署配置语义验证。' },
        { title: '开发者指南', subtitle: '二次开发', description: '接入 ToolEndpoint 与 Dora Node，打包 Manifest v2 Forge Skill，连接策略与传感器，并验证本地执行闭环。' },
      ],
    },
    langToggle: {
