  ...
  en: {
    ...
    hardware: {
      ...
      items: [
        ...
        { type: 'Bipedal Humanoid', description: 'Unitree R1-A5 bipedal humanoid target available through MuJoCo.' },
        { type: 'Wheeled Humanoid', description: 'Wheeled humanoid target combining mobility with upper-body manipulation in MuJoCo.' },
        { type: 'Wheeled Humanoid', description: 'Wheeled humanoid platform for perception, navigation, and manipulation on real robot and MuJoCo.' },
  ...
  zh: {
    ...
    hardware: {
      ...
      items: [
        ...
        { type: '桌面机械臂', description: '开源桌面机械臂硬件，支持真机、MuJoCo 与 Isaac Sim 接入，适合紧凑型操作评测。' },
        { type: '桌面机械臂', description: '开源桌面机械臂早期型号，当前通过 MuJoCo 接入。' },
        { type: '桌面机械臂', description: '协作型桌面机械臂目标，具备高精度关节控制，当前通过 MuJoCo 接入。' },
        { type: '桌面机械臂', description: '面向精细操作场景的桌面机械臂目标，当前通过 MuJoCo 接入。' },
        { type: '工业机械臂', description: '长臂展协作机械臂目标，适合大范围操作任务，当前通过 MuJoCo 接入。' },
        { type: '工业机械臂', description: '经典科研级机械臂目标，具备力矩感知能力，广泛用于 MuJoCo 操作算法验证。' },
        { type: '工业机械臂', description: '工业级精密机械臂目标，当前通过 MuJoCo 与 Target Adapter 接入。' },
        { type: '桌面机械臂', description: '高精度桌面机械臂目标，常用于遥操作与 MuJoCo 数据采集场景。' },
        { type: '桌面机械臂', description: '宇树机械臂目标，当前通过 MuJoCo 接入操作任务链路。' },
        { type: '工业机械臂', description: 'Universal Robots 协作机械臂目标，当前通过 MuJoCo 接入。' },
        { type: '工业机械臂', description: 'Kinova Gen3 协作机械臂目标，当前等待 Target Adapter 接入。' },
        { type: '桌面机械臂', description: '协作桌面机械臂目标，当前等待 Target Adapter 接入。' },
        { type: '四足机器人', description: '足式机器人目标。支持真机与 MuJoCo 下的移动操作与语义导航。' },
        { type: '四足机器人', description: '宇树四足机器人目标，当前通过 MuJoCo 接入运动与导航评测。' },
        { type: '四足机器人', description: '宇树 A1 四足机器人目标，当前通过 MuJoCo 接入。' },
        { type: '四足机器人', description: '宇树 A2 四足机器人目标，当前通过 MuJoCo 接入。' },
        { type: '四足机器人', description: '宇树 AS2 四足机器人目标，当前通过 MuJoCo 接入。' },
        { type: '四足机器人', description: '宇树 B1 四足机器人目标，当前通过 MuJoCo 接入。' },
        { type: '四足机器人', description: '宇树 B2 四足机器人目标，当前通过 MuJoCo 接入。' },
        { type: '四足机器人', description: '宇树 AlienGo 四足机器人目标，当前通过 MuJoCo 接入。' },
        { type: '双足人形', description: '全尺寸双足人形平台目标，支持真机与 MuJoCo 下的全身运动与操作。' },
        { type: '双足人形', description: '傅利叶双足人形平台，支持真机与 MuJoCo 下的通用具身任务。' },
        { type: '双足人形', description: '紧凑型双足人形硬件目标，适合在 MuJoCo 中快速评测。' },
        { type: '双足人形', description: '宇树 H1 双足人形目标，当前通过 MuJoCo 接入。' },
        { type: '双足人形', description: '宇树 H1-2 双足人形目标，当前通过 MuJoCo 接入。' },
        { type: '双足人形', description: '宇树 H2 双足人形目标，当前通过 MuJoCo 接入。' },
        { type: '双足人形', description: '宇树 H2-PLUS 双足人形目标，当前通过 MuJoCo 接入。' },
        { type: '双足人形', description: '宇树 R1-A5 双足人形目标，当前通过 MuJoCo 接入。' },
        { type: '轮式人形', description: '轮式人形硬件目标，兼顾移动效率与上肢操作，当前通过 MuJoCo 接入。' },
        { type: '轮式人形', description: '面向感知、导航与操作流程的轮式人形平台，支持真机与 MuJoCo。' },
        { type: '轮式人形', description: '支持真机与 MuJoCo 接入的轮式人形硬件，适合长程具身任务。' },
        { type: '移动操作机器人', description: '紧凑型轮式操作平台，支持真机与 MuJoCo，用于移动操作任务。' },
        { type: '移动操作机器人', description: '双臂移动操作目标，通过统一 Session 协议支持真机与 MuJoCo。' },
