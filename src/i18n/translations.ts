...
export const translations: Record<Lang, TranslationShape> = {
  ...
  zh: {
    ...
    architecture: {
      ...
      title: '双轨架构',
      highlight: '',
      description: 'Track A 负责认知推理，并基于任务经验持续自我进化。 Track B 负责连接物理世界，完成感知、控制与动作执行。',
      trackA: 'Track A',
      trackASub: '认知推理侧',
      trackB: 'Track B',
      trackBSub: '物理执行侧',
      ...
      inboundFlow: '观测',
      nodes: [
        { label: 'Agent Loop + Planner', sublabel: '认知推理', description: '基于上下文理解任务目标，选择当前可用技能与工具，并根据任务实时状态进行执行或调整。' },
        { label: 'Online Workflow', sublabel: '动态工作流编排', description: '支持上层智能体围绕任务动态构建工作流，并允许实时调整。' },
        { label: 'Task Verification', sublabel: '任务校验', description: '根据执行事实与相关证据判定动作执行情况，并总结归纳相关成功、失败经验。' },
        { label: 'Recursive Self-Improving', sublabel: '递归自进化', description: '基于过往所沉淀经验，进行相关分类与总结，进一步丰富各个技能的执行上下文（具体来说就是成功的变成技能，失败的添加上下文）。' },
        { label: 'Skill Runtime', sublabel: '技能运行时', description: '面向上层智能体提供完整技能列表，并管理其所需资源环境及相关运行上下文。' },
        { label: 'Tool Gateway', sublabel: '工具网关', description: '提供统一的算法工具调用接口，并对所有物理执行操作进行封装。' },
        { label: 'Runtime Dataflow', sublabel: '运行时数据流', description: '通过数据流驱动设计提供更加轻量、快速的通信性能。' },
        { label: 'Robot / Sensor / Env', sublabel: '底层硬件抽象', description: '对底层硬件构型、传感器（即仿真/真机环境）进行抽象描述，以支持整体框架进行任意状态读取与动作执行。' },
      ],
      flowLabel: '',
      flow: [],
    },
