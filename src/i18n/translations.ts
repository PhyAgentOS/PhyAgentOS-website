...
export const translations: Record<Lang, TranslationShape> = {
  en: {
    ...
    architecture: {
      ...
      highlight: '',
      description: 'Track A handles cognitive reasoning and continuously improves from task experience. Track B connects to the physical world for perception, control, and action execution.',
      trackA: 'Track A',
      trackASub: 'Cognitive Reasoning',
      trackB: 'Track B',
      trackBSub: 'Physical Execution',
      protocol: 'Tool API',
      sharedSurface: '',
      stateIsFile: '',
      ...
      nodes: [
        { label: 'Agent Loop + Planner', sublabel: 'Cognitive Reasoning', description: 'Understands task goals from context, selects available skills and tools, and executes or adjusts according to the task’s real-time state.' },
        { label: 'Online Workflow', sublabel: 'Dynamic Workflow Orchestration', description: 'Enables the agent to build workflows dynamically around each task and adjust them in real time.' },
        { label: 'Task Verification', sublabel: 'Task Verification', description: 'Uses execution facts and supporting evidence to evaluate actions, then summarizes the relevant successes and failures.' },
        { label: 'Recursive Self-Improving', sublabel: 'Recursive Self-Improvement', description: 'Classifies and summarizes accumulated experience to enrich the execution context of each skill.' },
        { label: 'Skill Runtime', sublabel: 'Skill Management', description: 'Provides the agent with a complete list of skills and manages their required environments, resources, and runtime context.' },
        { label: 'Tool Gateway', sublabel: 'Unified Tool Access', description: 'Provides a unified interface for algorithm tools and encapsulates all physical execution operations.' },
        { label: 'Runtime Dataflow', sublabel: 'Runtime Dataflow', description: 'Uses a dataflow-driven design to provide lightweight, responsive communication.' },
        { label: 'Robot / Sensor / Env', sublabel: 'Hardware Abstraction', description: 'Abstracts underlying hardware across physical and virtual environments, enabling the framework to read arbitrary states and execute actions.' },
      ],
      flowLabel: '',
      flow: [],
    },
    ...
    docsCTA: {
      ...
      description: 'Comprehensive documentation covering system architecture, operating steps, and hardware integration.',
      viewDocumentation: 'View Documentation',
      starOnGithub: 'Star on GitHub',
      joinDiscussion: 'Join Discussion',
      items: [
        { title: 'Architecture', subtitle: 'Technical Documentation', description: '' },
        { title: 'User Manual', subtitle: 'Installation & Operation', description: '' },
        { title: 'Developer Guide', subtitle: 'Secondary Development', description: '' },
      ],
    },
    langToggle: {
      switchTo: '切换语言',
