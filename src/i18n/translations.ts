  ...
  zh: {
    ...
    architecture: {
      ...
      nodes: [
        ...
        { label: 'Recursive Self-Improving', sublabel: '递归自进化', description: '基于过往所沉淀经验，进行相关分类与总结，进一步丰富各个技能的执行上下文。' },
        ...
        { label: 'Robot / Sensor / Env', sublabel: '底层硬件抽象', description: '对任意虚实环境中的底层硬件进行抽象描述，以支持整体框架进行任意状态读取与动作执行。' },
      ],
      flowLabel: '',
      flow: [],
    },
    ...
    docsCTA: {
      ...
      title: '入门所需的',
      highlight: '一切资料',
      description: '涵盖系统架构、操作步骤与硬件集成的全面文档。',
      viewDocumentation: '查看文档',
      starOnGithub: '在 GitHub 上 Star',
      joinDiscussion: '参与讨论',
      items: [
        { title: '系统架构', subtitle: '技术文档', description: '' },
        { title: '用户手册', subtitle: '安装与操作', description: '' },
        { title: '开发者指南', subtitle: '二次开发', description: '' },
      ],
    },
    langToggle: {
