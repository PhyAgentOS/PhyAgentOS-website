...
const hardwareDevices: HardwareDevice[] = [
  ...
  { name: 'SO-101', typeKey: 'Desktop Arm', image: '/media/hardware/so101.jpg', access: ['real', 'mujoco', 'isaac'], specs: ['Open Source', 'MuJoCo', 'Real Robot'] },
  { name: 'SO-100', typeKey: 'Desktop Arm', image: '/media/hardware/so100.webp', access: ['mujoco'], specs: ['Open Source', 'MuJoCo'] },
  ...
  { name: 'Kinova Gen3', typeKey: 'Industrial Arm', image: '/media/hardware/kinova-gen3.jpeg', access: ['mujoco'], specs: ['7-DoF', 'Collaborative', 'MuJoCo'] },
  { name: 'Dobot Nova 2', typeKey: 'Desktop Arm', image: '/dobot.png', access: ['mujoco'], specs: ['4-DoF', 'Collaborative', 'MuJoCo'] },
  { name: 'RealMan ECO62-B', typeKey: 'Desktop Arm', image: '/media/hardware/realman-eco62-b.png', access: ['mujoco'], specs: ['6-DoF', 'Collaborative', 'MuJoCo'] },
  { name: 'RealMan ECO63-B', typeKey: 'Desktop Arm', image: '/media/hardware/realman-eco63-b.png', access: ['mujoco'], specs: ['6-DoF', 'Collaborative', 'MuJoCo'] },
  { name: 'RealMan ECO65-B', typeKey: 'Desktop Arm', image: '/media/hardware/realman-eco65-b.png', access: ['mujoco'], specs: ['6-DoF', 'Collaborative', 'MuJoCo'] },
  { name: 'RealMan GEN72-B', typeKey: 'Desktop Arm', image: '/media/hardware/realman-gen72-b.jpg', access: ['mujoco'], specs: ['7-DoF', 'Collaborative', 'MuJoCo'] },
  { name: 'RealMan RM75-B', typeKey: 'Desktop Arm', image: '/media/hardware/realman-rm75-b.png', access: ['mujoco'], specs: ['7-DoF', 'Collaborative', 'MuJoCo'] },
  { name: 'RealMan RML63-B', typeKey: 'Desktop Arm', image: '/media/hardware/realman-rml63-b.png', access: ['mujoco'], specs: ['6-DoF', 'Collaborative', 'MuJoCo'] },
  { name: 'RealMan RXR-B', typeKey: 'Desktop Arm', image: '/media/hardware/realman-rxr-b.png', access: ['mujoco'], specs: ['Dual Arm', 'Collaborative', 'MuJoCo'] },
  ...
  { name: 'XLeRobot', typeKey: 'Wheeled', image: '/XLeRobot.png', access: ['mujoco'], specs: ['Mobile', 'Bimanual', 'MuJoCo'] },
...
const officialDeviceNames = new Set([
  'AgileX PIPER',
  'RealMan RM65-B',
  'RealMan ECO62-B',
  'RealMan ECO63-B',
...
const vendorOverrides: Record<string, string> = {
  ...
  'Kinova Gen3': 'Kinova',
  'Dobot Nova 2': 'Dobot',
  'RealMan ECO62-B': 'RealMan',
  'RealMan ECO63-B': 'RealMan',
  'RealMan ECO65-B': 'RealMan',
  'RealMan GEN72-B': 'RealMan',
  'RealMan RM75-B': 'RealMan',
  'RealMan RML63-B': 'RealMan',
  'RealMan RXR-B': 'RealMan',
  'Unitree Go2': 'Unitree',
  'Unitree Go1': 'Unitree',
  'Unitree A1': 'Unitree',
  'Unitree A2': 'Unitree',
...
export default function Targets() {
  ...
  const copy = lang === 'zh'
    ? {
        ...
        title: '持续扩展的',
        highlight: '机器人构型',
        description: '通过 Forge Skill 与统一 Tool API，将物理机器人和仿真模型作为可发现、可执行的工具能力接入。',
        search: '搜索品牌或设备型号',
        targetTypes: '构型',
        environments: '验证环境',
        allBrands: '全部品牌',
    ...
    : {
        ...
        description: 'Forge Skills and the unified Tool API expose physical robots and simulation models as discoverable, executable capabilities.',
